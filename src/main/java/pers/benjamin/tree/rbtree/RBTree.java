package pers.benjamin.tree.rbtree;
...
public class RBTree<T extends Comparable<T>> {
    ...
    /**
     * add value to a new node,if this value exist in this tree, if value exist,it will return the exist
     * value.otherwise return null if override mode is true,if value exist in the tree, it will override
     * the old value in the tree
     *
     * @param value
     * @return
     */
    ...
    /**
     * find the value by give value(include key,key used for search, other field is not used,@see
     * compare method).if this value not exist return null
     * 
     * @param value
     * @return
     */
